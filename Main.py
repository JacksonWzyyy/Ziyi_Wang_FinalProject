...
with tab1:
    st.markdown("""
                    ...
                    Furthermore, regarding Does individual player performance impact a team’s wins? Yes, but not always. there is a clearer positive correlation between Win Shares and team win rate, indicating that players who contribute more directly to their team's success (as quantified by Win Shares) tend to be on teams with higher win rates. Also, there is a positive relationship between PER and team win rate, suggesting that more efficient players tend to contribute to better team performance, though the correlation is not as pronounced as with Win Shares.
                    ...
                    - If you need further assistance with navigating or using the app, don't hesitate to reach out via the email.
