...
with tab1:
    ...
    - **Statistical Analysis:** Conducting robust statistical analysis required a deep understanding of both basketball analytics and statistical methodologies. Ensuring the validity and reliability of our results demanded careful consideration of various statistical techniques.
...
with tab2:
    ...
    choice = ['PTS_x', 'TRB_x', 'AST_x', 'PER']
    feature_fromuser = st.sidebar.multiselect('select feature', choice, default = ['PTS_x', 'PER'])
    points_fromuser = st.sidebar.slider('select PPG', 0, 50, (10,22))
